...
"""
def get_names_worksheets(Workbook, print_value: bool=False):
...
def len_columns(plan, print_value: bool=False):
...
def get_colun_data(plan, column: int, convert_tuple: bool=True, print_values: bool=True) -> list[str] or tuple(str):
